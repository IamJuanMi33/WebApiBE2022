...
{
    /// <inheritdoc />
    public partial class DogKennel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DogKennel", x => new { x.DogId, x.KennelId });
                    table.ForeignKey(
                        name: "FK_DogKennel_Dogs_DogId",
                        column: x => x.DogId,
                        principalTable: "Dogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DogKennel_Kennels_KennelId",
                        column: x => x.KennelId,
