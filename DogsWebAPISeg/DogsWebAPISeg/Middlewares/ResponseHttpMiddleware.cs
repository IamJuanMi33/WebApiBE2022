...
namespace DogsWebAPISeg.Middlewares
{
    ...
    public class ResponseHttpMiddleware
    {
        ...
        //Para poder utilizar la clase como Middleware se necesita el método
        //Invoke o InvokeAsync si es asíncrono
        //Además, debe retornar un Task
